defmodule AcqdatApiWeb.Alerts.AlertRulesView do
  ...
  def render("alert_rules.json", %{alert_rules: alert_rules}) do
    ...
    %{
      ...
      recepient_ids: render_many(alert_rules.recepient_ids, AlertRulesView, "recepient.json"),
  ...
  def render("alert_rules_index.json", %{alert_rules: alert_rules}) do
    {:ok, severity} = AlertSeverityEnum.dump(alert_rules.severity)
  ...
  def render("index.json", alert_rules) do
    %{
      alert_rules: render_many(alert_rules.entries, AlertRulesView, "alert_rules_index.json"),
